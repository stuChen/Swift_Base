...
//            }
            bgImageView.kf.setImage(with: URL(string: url), placeholder: nil, options: [.transition(ImageTransition.flipFromLeft(0.25))], progressBlock: nil, completionHandler: nil)
